...
;---------------------
    ...
    MOVWF refTemp
    MOVLW 60 ; this is the input value
    MOVWF measuredTemp
...
;---------------------
; ERROR ((WDTTMR) and 0FFh), 2, b: Handle out-of-range values
;---------------------
ERROR_STATE:
    BSF PORTD,3 ; turn on an error LED
...
;---------------------
    ...
    ;MOVLW 60 ; this is the input value ; used to replace back to negative value
    ;MOVWF measuredTemp
